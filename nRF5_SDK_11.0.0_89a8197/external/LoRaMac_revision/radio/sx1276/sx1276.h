...
typedef struct SX1276_s
{
    ...
    nrf_drv_gpiote_in_config_t Reset_in;
    nrf_drv_gpiote_out_config_t Reset_out;
    nrf_drv_gpiote_in_config_t DIO0;
    nrf_drv_gpiote_in_config_t DIO1;
    nrf_drv_gpiote_in_config_t DIO2;
    nrf_drv_gpiote_in_config_t DIO3;
    nrf_drv_gpiote_in_config_t DIO4;
    nrf_drv_gpiote_in_config_t DIO5;

    //Spi_t         Spi;
    nrf_drv_spi_config_t Spi;
    nrf_drv_spi_t Spi_master; 
