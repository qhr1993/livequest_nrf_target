...
#define BLE_UUID_OUR_SERVICE_UUID                0xBBBB // Just a random, but recognizable value

// ALREADY_DONE_FOR_YOU: Defining 16-bit characteristic UUID
#define BLE_UUID_OUR_CHARACTERISTC_UUID          0xCCCC // Just a random, but recognizable value
